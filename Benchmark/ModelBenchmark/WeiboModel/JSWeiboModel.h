...
@interface JSWeiboPictureMetadata : JSONModel
...
@end
@interface JSWeiboPicture : JSONModel
...
@protocol JSWeiboURL
@end
@interface JSWeiboURL : JSONModel
...
@interface JSWeiboUser : JSONModel
...
@interface JSWeiboStatus : JSONModel
